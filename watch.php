...
<div id="content">
    ...
    <div  id="movie-display">
        ...
        <div class="row body_video">
            <div class="col-sm-12">
                ...
                ?>
                <iframe src="https://drive.google.com/file/d/<?php echo $r4['linkfilm'] ?>/preview?" 
    ...
    <div  id="server-list">
        <div class="row">
            <div>
            <p>Bạn đang xem phim <a href="#"><?php echo $r3['name'] ?></a> online chất lượng cao miễn phí tại webphim.net</p>
            </div>        
        </div>
    </div>
</div>
